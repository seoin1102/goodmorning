                    ...
                    <Grid container spacing={1} >
                        ...
                        <Grid item xs={11.92} >
                            ...
                            <Grid item xs={12} sx={{display: 'flex'}}>
                                <div style={{padding: '0 0 0 10px', margin: '0 0 8px 0', backgroundColor: '#e8ebed', border: '1px solid #E1E1E9', color: 'blue', borderRadius: '5px'}}>
                                  {`${messageItem.commit}`}
                                </div>
                                <div>&nbsp;</div>
                                <div style={{margin: '0 0 8px 0', backgroundColor: '#e8ebed', border: '1px solid #E1E1E9', color: 'yellow', borderRadius: '5px'}}>
                                  {`${messageItem.status}`}
                                </div>
                                <div>&nbsp;</div>
